...
export class ContactService {
  private contactInfo: ContactInfo = {
    address: 'كلية التربية – جامعة الأقصر – الأقصر – مدينة طيبة الجديدة، بجوار هيئة مدينة طيبة الجديدة',
    ...
    importantLinks: [
      {
        ...
        description: 'الوصول إلى البوابة الرئيسية للجامعة للحصول على معلومات شاملة',
        icon: 'pi pi-globe'
      },
      {
